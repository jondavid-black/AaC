...
def get_commands() -> list[AacCommand]:
    ...
    """
    report_arguments = [
        AacCommandArgument("report_definition_file", "The yaml file containing the report model."),
        AacCommandArgument("architecture_file", "The yaml file containing the AaC model to interrogate."),
        AacCommandArgument("--output_file", "The file to write the generated YAML report. (Optional)"),
    ]
    report_csv_arguments = [
        AacCommandArgument("report_definition_file", "The yaml file containing the report model."),
        AacCommandArgument("architecture_file", "The yaml file containing the AaC model to interrogate."),
        AacCommandArgument("--output_file", "The file to write the generated CSV report. (Optional)"),
    ]
